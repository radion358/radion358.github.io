$(document).ready(function() {
  const apiRoot = 'https://boiling-cove-96764.herokuapp.com/v1';
  const trelloApiRoot = 'https://boiling-cove-96764.herokuapp.com//v1/trello';
  ...
  function handleCardCreationRequest(event) {
    var requestUrl = trelloApiRoot + '/card';
